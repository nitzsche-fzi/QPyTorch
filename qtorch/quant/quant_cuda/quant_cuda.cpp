...
Tensor fixed_point_unsigned_quantize_nearest(Tensor a, int wl, int fl, bool use_clamp)
{
  CHECK_INPUT(a);
  return fixed_point_unsigned_quantize_nearest_cuda(a, wl, fl, use_clamp);
}

std::tuple<Tensor, Tensor> fixed_point_unsigned_quantize_nearest_mask(Tensor a, int wl, int fl)
{
  CHECK_INPUT(a);
  return fixed_point_unsigned_quantize_nearest_mask_cuda(a, wl, fl);
}
...
Tensor fixed_point_unsigned_quantize_stochastic(Tensor a, int wl, int fl, bool use_clamp)
{
  CHECK_INPUT(a);
  return fixed_point_unsigned_quantize_stochastic_cuda(a, wl, fl, use_clamp);
}

std::tuple<Tensor, Tensor> fixed_point_unsigned_quantize_stochastic_mask(Tensor a, int wl, int fl)
{
  CHECK_INPUT(a);
  return fixed_point_unsigned_quantize_stochastic_mask_cuda(a, wl, fl);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("fixed_point_unsigned_quantize_stochastic", &fixed_point_unsigned_quantize_stochastic, "Fixed Point Unsigned Number Stochastic Quantization (CUDA)");
  m.def("fixed_point_unsigned_quantize_stochastic_mask", &fixed_point_unsigned_quantize_stochastic_mask, "Fixed Point Unsigned Number Stochastic Quantization (CUDA)");
  ...
  m.def("fixed_point_unsigned_quantize_nearest", &fixed_point_unsigned_quantize_nearest, "Fixed Point Unsigned Number Nearest Neighbor Quantization (CUDA)");
  m.def("fixed_point_unsigned_quantize_nearest_mask", &fixed_point_unsigned_quantize_nearest_mask, "Fixed Point Unsigned Number Nearest Neighbor Quantization (CUDA)");
